...
MACOSX_DEPLOYMENT_TARGET=11.0 ./build-macos.sh -v 5.0.4 --flavor legacy
```
...
MACOSX_DEPLOYMENT_TARGET=10.13 ./build-macos.sh -v 5.0.4 --flavor high-sierra
```

This produces High Sierra-specific artifacts:

- `Garage-5.0.4-macOS-high-sierra-x86_64.dmg`
- `Garage-5.0.4-macOS-high-sierra-x86_64.dmg.sha`
