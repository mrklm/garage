...
![Version](https://img.shields.io/badge/version-5.0.5-green)
...
- **Linux**  
  - `Garagev5.0.5-linux-x86_64.Appimage`
  - `Garagev5.0.5-linux-x86_64.Appimage.sha`
  - `Garage v5.0.5 linux-x86_64.tar.gz`
  - `Garage v5.0.5 linux-x86_64.tar.gz.sha`
  - `SHA256SUMS-Garage-v5.0.5.txt`

- **macOS**  
  - `Garage-5.0.5-macOS-x86_64.dmg`
  - `Garage-5.0.5-macOS-x86_64.dmg.sha`

- **Windows**  
  - `Garage-v5.0.5-windows-x86_64.zip`
  - `Garage-v5.0.5-windows-x86_64.zip.sha`
...
```bash
chmod +x Garagev5.0.5-linux-x86_64.Appimage
./Garagev5.0.5-linux-x86_64.Appimage
```
...
```bash
tar -xzf "Garage v5.0.5 linux-x86_64.tar.gz"
cd "Garage v5.0.5 linux-x86_64"
./Garage
```
