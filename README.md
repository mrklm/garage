...
- **Linux**  
  - `Garagev4.5.9-linux-x86_64.Appimage`
  - `Garagev4.5.9-linux-x86_64.Appimage.sha`
  - `Garage v4.5.9 linux-x86_64.tar.gz`
  - `Garage v4.5.9 linux-x86_64.tar.gz.sha`

- **macOS**  
  - `Garage-4.5.9-macOS-x86_64.dmg `
  - `Garage-4.5.9-macOS-x86_64.dmg.sha`

- **Windows**  
  - `Garage-v4.5.9-windows-x86_64.zip`
  - `Garage-v4.5.9-windows-x86_64.zip.sha`
...
```bash
chmod +x Garagev4.5.9-linux-x86_64.Appimage
./Garagev4.5.9-linux-x86_64.Appimage
```
...
```bash
tar -xzf "Garage v4.5.9 linux-x86_64.tar.gz"
cd "Garage v4.5.9 linux-x86_64"
./Garage
```
